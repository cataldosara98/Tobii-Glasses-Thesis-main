...
def main():
    ...
    right_viewer_column = [
        ...
        [sg.Button("7. Creazione del file blinkDetected.csv", key="-KEY7-", size=(50, 1), tooltip="il file .csv contiene i dati relativi \n"
                                                                                                     "ai blink rilevati durante il \n"
                                                                                               "tracciamento, con i tempi di inizio e fine")],
        [sg.Button("8. Generazione grafico Blink in intervallo di tempo", key="-KEY8-", size=(50, 1), tooltip="Grafico Blink")],
